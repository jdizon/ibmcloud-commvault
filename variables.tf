variable "ibmcloud_api_key" {
    ...
    default     = "2B0FaISo5axDADi8TI4C45mqerYknJ8kPQKnYO1x_rL_"
}
...
variable "power_instance_id" {
    ...
    default     = "crn:v1:bluemix:public:power-iaas:syd04:a/1dd42ed8fa364cd281b09533a423511d:d5838e1e-cc17-4e90-bdef-4202d4e2cb78::"
}
